//This script is responsible for the gradient colour representation on the panel
//
...
public class UIImageGradient : BaseMeshEffect
{
    ...
    //Checking is vertical or not
    [Header("Vertical or not")]
    public bool isVertical = true;
    //Checking is multiple color or not
    [Header("Is Multiple color or not")]
    ...
    private void ModifyVertices(VertexHelper vh)
    {
        ...
        //For every letter, its devided into two triangle, with 6 vertix
        //5 and 0 are in the same position
        //2 and 3 are in the same position 
        /**
         *   5-0 ---- 1
         *    | \    |
         *    |  \   |
        ...
        //The add up number of vertices per letter
    ...
    //Acorrding the ratio to create vertex
    //Time = the ratio according to color
